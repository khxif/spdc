  ...
  return (
    <section className="relative py-16 min-w-screen animation-fade animation-delay">
      <div className="container px-4 mx-auto">
        <p
          className="text-xs font-bold text-left text-primary-blue uppercase sm:mx-6 sm:text-center sm:text-normal sm:font-bold"
          data-primary="pink-500"
        >
          Got a Question? We’ve got answers.
        </p>
        <h3 className="mt-1 text-2xl font-bold text-left sm:mx-6 sm:text-3xl md:text-4xl lg:text-5xl sm:text-center sm:mx-0">
        ...
        >
          <h3
            className="text-lg font-bold text-primary-blue sm:text-xl md:text-2xl"
            data-primary="purple-500"
          >
            How much does it cost for an e-commerce website?
          </h3>
          <p className="mt-2 text-base text-gray-800 sm:text-lg md:text-normal">
